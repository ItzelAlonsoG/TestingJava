...
public class MovieService {
   ...
   private MovieRepository movieRepository;
    ...
    public Collection<Movie> finMoviesByLength(int lenght) {
    ...
    public Collection <Movie> findByDirector (String director) {
        return  movieRepository.findAll().stream().filter(movie -> movie.getDirector() == director).collect(Collectors.toList());
    }
